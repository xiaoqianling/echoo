...
import { messagesStore, fetchMessages, sendMessage } from '../../../shared/stores/messagesStore';
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-xl font-bold text-gray-800 mb-4">Send New Message</h2>
            ...
            <form onSubmit={handleSendMessage}>
              ...
              <div class="mb-4">
                <label class="block text-gray-700 text-sm font-medium mb-2">Description (Markdown)</label>
                <textarea
                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  rows={4}
                  value={desp()}
        ...
        <div class="lg:col-span-2">
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            {messagesStore.isLoading ? (
              ...
              <Show when={messagesStore.messages.length > 0} fallback={<div class="text-center py-10 text-gray-500">No messages yet</div>}>
                <div class="space-y-4">
                  <For each={messagesStore.messages}>
                    {message => (
                      <div class="border-b border-gray-200 pb-4 last:border-b-0 last:pb-0">
                        ...
                        {message.desp && (
                          <div class="text-gray-600 mb-3 whitespace-pre-wrap">{message.desp}</div>
                        )}
