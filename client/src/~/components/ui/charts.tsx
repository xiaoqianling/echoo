...
function showTooltip(context: ChartContext) {
  ...
  el.className = `chartjs-tooltip ${model.yAlign ?? `no-transform`}`;
  ...
  body.forEach((line, i) => {
    ...
    content += `
        <div class="tooltip-item">
          <span class="color-box" style="background: ${colors.backgroundColor}; border-color: ${colors.borderColor}"></span>
          ${line}
        </div>`;
  });
  content += `</div>`;
